...
use StuPla\CloudSDK\rocketchat\Exceptions\UserActionException;
...
class UserClient extends Client
{
    ...
    const API_PATH_USER_PERSONAL_TOKEN  = 'users.generatePersonalAccessToken';
    const API_PATH_USER_PERSONAL_TOKEN_RE  = 'users.regeneratePersonalAccessToken';
    ...
    public function generatePersonalToken($tokenName)
    {
        $response = $this->request()->post($this->apiUrl(self::API_PATH_USER_PERSONAL_TOKEN))->body([
            "tokenName" => $tokenName,
        ...
        {
            $response = $this->request()->post($this->apiUrl(self::API_PATH_USER_PERSONAL_TOKEN_RE))->body([
                "tokenName" => $tokenName
            ])->send();
            return $this->handleResponse($response, new UserActionException());
        }
