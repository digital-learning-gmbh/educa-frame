...
use StuPla\CloudSDK\calendarful\Recurrence\RecurrenceFactory;
...
class CalendarTest extends TestCase
{
	...
	public function testSameFromAndToDate()
	{
		...
		$eventRegistry = m::mock('\StuPla\CloudSDK\calendarful\Event\EventRegistryInterface');
        ...
        $eventRegistry->shouldReceive('getVactionTimes')
            ->once()
            ->andReturn(array());
	...
	public function testOverriddenDailyEventRemoval()
	{
		...
		$recurrenceFactory->addRecurrenceType('daily', 'StuPla\CloudSDK\calendarful\Recurrence\Type\Daily');
	...
	{
		$recurrenceFactory = new RecurrenceFactory();
		$recurrenceFactory->addRecurrenceType('weekly', 'StuPla\CloudSDK\calendarful\Recurrence\Type\Weekly');
	...
	{
		$recurrenceFactory = new RecurrenceFactory();
		$recurrenceFactory->addRecurrenceType('monthly', 'StuPla\CloudSDK\calendarful\Recurrence\Type\MonthlyDate');
