    ...
    <div class="container-fluid">
        ...
        <div class="row mt-5">
            ...
            @foreach($data->kategorien as $kategorie)
                ...
                @endphp
            <div class="selectAreaWizard col-md-5 @if($selected_id != null || $parent_id == -1) d-none d-md-block  @endif">
        ...
        <div class="row mt-3">
            ...
            <div class="col-7">
                <h4>{{ __('preiskalkulator.myAdditionalServices') }}</h4>
                ...
                <div class="optionBlock mt-2">
                    <label>@if(count($selectobs) > 1){{ __('preiskalkulator.price') }}: {{ $selectobs[1]->preis }}€ @endif</label>
                    @if(count($selectobs) > 1 || count($selectobs) == 0)
                    <a class="optionBlock secondary float-right" href="/external/preiskalkulator?id=5"> {{ __('preiskalkulator.next') }} <i class="fas fa-arrow-right"></i></a>
                    @endif
