...
@section('content')
    ...
    <p>Wenn Sie weitere Zugangscodes für das Praxisportal benötigen oder Rückfragen haben, wenden Sie sich bitte per Email an Frau Kerstin Allroggen,  kerstin.allroggen@fuu.de.</p>
