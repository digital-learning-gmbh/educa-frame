<div class="card" id="detailsShow" style="display: none;">
    <div class="card-header"><b id="klassenbuch_title"></b>
        ...
        <a href="#" onclick="$('#detailsShow').hide();" class="btn m-1 btn-xs btn-secondary float-right"><i class="fas fa-times"></i></a>
        <a href="#" onclick="saveKlassenbuch();" class="btn btn-xs m-1 btn-success float-right"><i class="fas fa-check"></i></a>
...
<script>
    ...
    function saveKlassenbuch() {
        ...
        postData('/klassenbuch/' + orginalEvent.klassen_id[0] + '/ajax/save', { start: orginalEvent.start.format(),
            ...
            form_data : x, presence: anwesenheit }, '{{ csrf_token() }}',(data) => {
            console.log(data);
