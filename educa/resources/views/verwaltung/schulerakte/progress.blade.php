...
@section('siteContent')
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header"><b>Lernfortschritt des Schülers</b></div>
...
@section('additionalScript')
    <script>
        ...
        {
            postDataHtml('/board/ajax/lernfortschrittSchuler', { klasse_id : '{{ $schuler->id }}', stichtag : '{{ date("Y-m-d H:i") }}' }, '{{ csrf_token() }}',(data) => {
