...
export function ActivityWidget(props) {
    ...
    const loadData = () => {
        ...
        setIsLoading(true)
        AjaxHelper.getSystemSettingsGeneralWidgetActivity(moment(startDay).unix(),moment(endDay).unix())
            .then(resp => {
    ...
    return <Card style={{height: "100%"}}>
        <Card.Header style={{backgroundColor: "#fff"}}>
            <h5 className="card-title"><b><i className="fas fa-wave-square"></i> Aktivität</b>
