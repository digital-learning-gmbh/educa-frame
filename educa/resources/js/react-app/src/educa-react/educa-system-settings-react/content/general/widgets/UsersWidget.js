...
export function UsersWidget(props) {
    ...
    const loadData = () => {
        ...
        setIsLoading(true)
        AjaxHelper.getSystemSettingsGeneralWidgetInfoActiveUsers(moment(startDay).unix(),moment(endDay).unix())
            .then(resp => {
    ...
    return <Card style={{height: "100%"}}>
        <Card.Header style={{backgroundColor: "#fff"}}>
            <h5 className="card-title"><b><i className="fas fa-users"></i> Nutzer von educa</b>
