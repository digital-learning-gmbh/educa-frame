...
export function LearnContentCountWidget(props) {
    ...
    const loadData = () => {
        ...
        setIsLoading(true)
        AjaxHelper.getSystemSettingsGeneralWidgetLearnContentObjects(moment(startDay).unix(),moment(endDay).unix())
            .then(resp => {
    ...
    return <Card style={{height: "100%"}}>
        <Card.Header style={{backgroundColor: "#fff"}}>
            <h5 className="card-title"><b><i className="fa fas fa-object-group"></i> Lerninhalte</b>
...
export default LearnContentCountWidget
