...
export function NewUsersWidget(props) {
    ...
    const loadData = () => {
        ...
        setIsLoading(true)
        AjaxHelper.getSystemSettingsGeneralWidgetInfoNewUsers(moment(startDay).unix(),moment(endDay).unix())
            .then(resp => {
    ...
    return <Card style={{height: "100%"}}>
        <Card.Header style={{backgroundColor: "#fff"}}>
            <h5 className="card-title"><b><i className="fas fa-users"></i> Neue Nutzer</b>
