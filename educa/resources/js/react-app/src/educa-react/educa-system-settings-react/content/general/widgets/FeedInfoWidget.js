...
export function FeedInfoWidget(props) {
    ...
    const loadData = () => {
        ...
        setIsLoading(true)
        AjaxHelper.getSystemSettingsGeneralWidgetInfoFeed(moment(startDay).unix(),moment(endDay).unix())
            .then(resp => {
    ...
    return <Card style={{height: "100%"}}>
        <Card.Header style={{backgroundColor: "#fff"}}>
            <h5 className="card-title"><b><i className="fas fa-rss"></i> Feed-Auswertung</b>
        ...
        <Card.Body>
            <div className={"d-flex flex-column"}>
                <div>
                    <Bar data={chartData} height={350} options={options}/>
                </div>
            </div>
        </Card.Body>
    </Card>
