...
if (document.querySelector('.editor') != null) {
  window.editor = DecoupledDocumentEditor.create(document.querySelector('.editor'), {
    ...
    window.editor = editor; // Set a custom container for the toolbar.
...
module.exports = __webpack_require__(/*! E:\schule_plus\stundenplaner_fullcalendar\stupla\resources\js\editor.js */"./resources/js/editor.js");
