        ...
        if (slots) {
            ...
            for (var i = 0; i < slots.length; i++) {
                ...
                if (nextSlot) {
                    ...
                    breakHtml = (breakHeight > 0) ? '<tr class="fc-timeslots-break" style="height:' + breakHeight + 'px;"><td class="fc-break-axis"><div class="fc-timeslots-axis">Pause</div></td><td class="fc-timeslots-break-content"></td></tr>' : '';
                }
                slotHeight = moment.duration(endTime.diff(startTime)).asMinutes() * 1.2;
                var timeHtml = '';
